public class Day_1 {
    public static void main(String[] args) throws java.io.IOException {
        java.util.List<Integer> l = java.nio.file.Files.readAllLines(java.nio.file.Paths.get("src/entries_d1.txt")).stream().map(Integer::parseInt).collect(java.util.stream.Collectors.toList());
